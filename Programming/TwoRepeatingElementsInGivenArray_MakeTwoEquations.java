...
public class TwoRepeatingElementsInGivenArray_MakeTwoEquations {

	public static void main(String[] args) {
		TwoRepeatingElementsInGivenArray_MakeTwoEquations repeat = new TwoRepeatingElementsInGivenArray_MakeTwoEquations();
